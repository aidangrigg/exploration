...
bool Lambertian::scatter(const Ray &, const HitRecord &rec, Colour &attenuation,
                         Ray &scattered) const {
...
bool Metal::scatter(const Ray &r_in, const HitRecord &rec, Colour &attenuation,
                    Ray &scattered) const {
...
bool Dielectric::scatter(const Ray &r_in, const HitRecord &rec, Colour &attenuation,
                         Ray &scattered) const {
